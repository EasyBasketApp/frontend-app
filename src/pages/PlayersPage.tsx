        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant='h6' color='text.secondary' sx={{ mb: 6 }}>
              Track player performance, statistics, and development with advanced analytics
            </Typography>
                        ...
                        <Box sx={{ flex: 1 }}>
                          ...
                          <Stack direction='row' spacing={1} sx={{ mt: 1 }}>
                            <Chip
                              size='small'
                              label={player.height}
                              icon={<Height sx={{ fontSize: '16px !important' }} />}
                              variant='outlined'
                            />
                            <Chip size='small' label={player.experience} variant='outlined' />
                          </Stack>
                        </Box>
                      </Box>
            ...
            <Box sx={{ textAlign: 'center', mt: 8 }}>
              ...
              <Typography variant='body1' color='text.secondary' sx={{ mb: 4 }}>
                Register new players with comprehensive performance tracking and development analytics.
              </Typography>
              <Button
                variant='contained'
                size='large'
