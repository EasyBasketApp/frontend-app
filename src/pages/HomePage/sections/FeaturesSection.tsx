...
import { Box, Grid, Card, CardContent, Avatar, Typography, Container } from '@mui/material'
  ...
  return (
    ...
    >
      <Container maxWidth='lg'>
        ...
        <Grid container spacing={6} sx={{ mt: 4 }} display='flex' justifyContent='center'>
          {data.features.map(feature => (
            <Grid key={feature.title} size={{ xs: 12, sm: 6, md: 4 }} display='flex' justifyContent='center'>
              <Card
                elevation={8}
                tabIndex={0}
                sx={{
              ...
              >
                <CardContent sx={{ textAlign: 'center', p: 4 }}>
                  ...
                  <Typography variant='h5' sx={{ fontWeight: 800, mb: 2, letterSpacing: 0.5 }} gutterBottom>
                    {feature.title}
                  </Typography>
