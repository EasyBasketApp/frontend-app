...
import { Alert, Box, Button, CardContent, CircularProgress, Link, Typography } from '@mui/material'
      ...
      <CardContent sx={{ p: 4 }}>
        ...
        <Box component='form' onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <Button
            ...
            sx={{ mt: 3, mb: 2, py: 1.5 }}
            startIcon={registerMutation.isPending ? <CircularProgress size={20} color='inherit' /> : <PersonAdd />}
          >
