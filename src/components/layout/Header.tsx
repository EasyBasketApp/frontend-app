...
import { SportsBasketball, AccountCircle, Logout, Dashboard, Group, Person, Event } from '@mui/icons-material'
      ...
      <Toolbar sx={{ px: { xs: 2, md: 4 } }}>
        ...
        {isAuthenticated ? (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            >
              <MenuItem onClick={handleDashboard} sx={{ borderRadius: 1, mx: 1 }}>
                <Dashboard sx={{ mr: 2 }} />
                Dashboard
              </MenuItem>
